...
intro.bluebutton=Button(intro,image=intro.loadimage,command=main2,bg='black')
intro.bluebutton.place(x=600,y=450)

intro.loadimage1=PhotoImage(file="blueball2.png")
intro.bluebutton1=Button(intro,image=intro.loadimage1,command=gamehelp,bg='black')
